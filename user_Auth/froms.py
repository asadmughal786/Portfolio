...
class User_registerations(forms.Form):
    ...
    user_country = forms.CharField(label='Country',widget=forms.TextInput(attrs={'autocomplete':'off','class':'form-control','placeholder':'City'}),validators=[validators.MaxLengthValidator(15)])
...
class profile(User_registerations,skills,Education,ProfessionalExp):
    user_name = forms.CharField(label='Skill Name',widget=forms.TextInput(attrs={'autocomplete':'off','class':'form-control','placeholder':'Skill Name'}))
